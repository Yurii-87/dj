(() => {
    ...
    ne(),
      document.querySelector(".slider__slider") &&
        new se(".slider__slider", {
          ...
          speed: 500,
          loop: !0,
          navigation: { nextEl: ".slider__next", prevEl: ".slider__prew" },
          breakpoints: {
  ...
  const ae = document.querySelector(".play"),
    oe = document.querySelector(".new__audio"),
    le = document.querySelector(".player__progress-container"),
    de = document.querySelector(".player__progress"),
    ce =
      (document.querySelector(".player__time-container"),
      document.querySelector(".player__time-trak")),
    pe = document.querySelector(".player__progress-time");
  let ue = Math.floor(oe.duration / 60);
  ue < 10 && (ue = "0" + String(ue));
  let he = Math.floor(oe.duration % 60);
  he < 10 && (he = "0" + String(he));
  function fe() {
    oe.play(), ae.classList.add("play-music"), (ae.onclick = me);
  }
  function me() {
    oe.pause(), ae.classList.remove("play-music"), (ae.onclick = fe);
  }
  (ae.onclick = fe),
    oe.addEventListener("timeupdate", function (e) {
      const { duration: t, currentTime: s } = e.srcElement,
        i = (s / t) * 100;
      de.style.width = `${i}%`;
      {
        let e = Math.floor(oe.currentTime / 60);
        e < 10 && (e = "0" + String(e));
        let t = Math.floor(oe.currentTime % 60);
        t < 10 && (t = "0" + String(t)), (pe.innerHTML = `${e}:${t}`);
      }
    }),
    (le.onclick = function (e) {
      const t = this.offsetWidth,
        s = e.offsetX,
        i = oe.duration;
      oe.currentTime = (s / t) * i;
    }),
    ae.addEventListener("click", function () {
      let e = Math.floor(oe.duration / 60);
      e < 10 && (e = "0" + String(e));
      let t = Math.floor(oe.duration % 60);
      t < 10 && (t = "0" + String(t)), (ce.innerHTML = `${e}:${t}`);
    });
  const ge = document.querySelector(".tracks__audio"),
    ve = document.querySelector(".tracks__play-btn");
  ge.src;
  const we = document.querySelector(".tracks__progress-container"),
    Se = document.querySelector(".tracks__progress-songs"),
    Te = document.querySelector(".tracks__progress-time"),
    be = document.querySelector(".tracks__oll-time");
  function Ee(e) {
    ge.play(), ve.classList.add("tracks__play"), (ve.onclick = ye);
  }
  function ye(e) {
    ge.pause(), ve.classList.remove("tracks__play"), (ve.onclick = Ee);
  }
  (ve.onclick = Ee),
    ge.addEventListener("timeupdate", function () {
      const e = ge.duration,
        t = ge.currentTime;
      let s = (t / e) * 100;
      Se.style.width = `${s}%`;
    ...
    (we.onclick = function (e) {
      const t = we.offsetWidth,
        s = ge.duration,
        i = e.offsetX;
      ge.currentTime = (i / t) * s;
    });
  document
    .querySelector(".tracks__list")
    .addEventListener("click", function (e) {
      const t = e.target;
      if (t.closest(".tracks__link")) {
        t.classList.add("_action");
        let e = t.href;
        (ge.src = `${e}`), Ee();
      }
      if (t.closest("._action")) {
        const e = document.querySelectorAll("._action");
        e.length &&
          e.forEach((e) => {
            e.classList.remove("_action");
          }),
          t.classList.add("_action");
      }
      e.preventDefault();
